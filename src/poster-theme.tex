...
\tcbset{
  ...
  appcard/.style={
    enhanced,
    colback=white,
    colframe=PosterPrimary!86!black,
    boxrule=2.1pt,
    arc=5mm,
    left=7mm,
    right=7mm,
...
\newtcolorbox{PosterAppCard}[2][]{appcard,title={#2},#1}
...
\newcommand{\PosterAppImage}[3][height=215mm]{%
  \begin{center}
    \IfFileExists{#2}{\includegraphics[#1,keepaspectratio]{#2}}{\PosterFigurePlaceholder[215mm]{#3}}%
  \end{center}
}

\newcommand{\PosterAppLogo}[2][height=18mm]{%
...
\newcommand{\PosterStatus}[1]{%
  \tikz[baseline=(X.base)]\node[fill=PosterPrimary!10, draw=PosterPrimary!80!black,
    rounded corners=2mm, inner xsep=3mm, inner ysep=1.2mm, font=\large\bfseries,
    text=PosterPrimary!85!black] (X) {#1};%
}

\newcommand{\PosterAppBullets}[4]{%
  \begin{itemize}
